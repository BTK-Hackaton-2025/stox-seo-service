...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in product_image_analyzer_pb2_grpc.py depends on'
...
class ProductImageAnalyzerStub(object):
...
def add_ProductImageAnalyzerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ProductImageAnalyzer', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ProductImageAnalyzer', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class ProductImageAnalyzer(object):
    """Missing associated documentation comment in .proto file."""
